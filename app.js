...
app.post('/auth/login', async(req, res) => {
  ...
  try {
    ...
    res.status(200).json({msg: "A autenticação foi realizada com sucesso!", token})
...
mongoose.connect(`mongodb+srv://${dbUser}:${dbPass}@cluster0.fxmaoj6.mongodb.net/?retryWrites=true&w=majority`).then(
  app.listen(port, () => {
